...
public class Inventory : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        for (int i = 0; i <maxCount; i++) //11111111111111111111111111111111111111111111111111111111111
        {
            AddItem(i, data.items[Random.Range(0, data.items.Count)], Random.RandomRange(1, 99));
